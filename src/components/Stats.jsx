                ...
                <div className="flex flex-wrap -mx-4 mt-auto mb-auto w-full lg:w-1/2 content-start sm:pr-10">
                    <div className="w-full sm:p-4 px-4 mb-6">
                        ...
                        <div className="flex h-1 w-full overflow-hidden rounded bg-gray-200 mb-6">
                            <div className="h-full w-[3%] bg-indigo-500"></div>
                            <div className="h-full w-[3%] bg-white"></div>
                            <div className="h-full w-[10%] bg-pink-500"></div>
                        </div>
                    ...
                    <div className="flex flex-wrap w-full">
                        <div className="p-4 w-1/2 sm:w-1/2 md:w-1/3">
                            ...
                            <p className="leading-relaxed text-sm sm:text-base md:text-lg font-bold">Projects Completed</p>
                        </div>
                        <div className="p-4 w-1/2 sm:w-1/2 md:w-1/3">
                            <h2 className="title-font font-medium text-4xl sm:text-5xl text-gray-900 mb-2">
                                256<sup className="text-pink-500 text-xl sm:text-2xl font-semibold align-super">K</sup>
                            </h2>
                            <p className="leading-relaxed text-sm sm:text-base md:text-lg font-bold">Satisfied Clients</p>
                        </div>
                    </div>
                </div>
