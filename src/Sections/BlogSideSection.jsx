  ...
  const BlogSideSection = () => {
    ...
    return (
      <aside className="w-[97%] lg:w-full xl:w-[90%] mt-10 ">
        ...
        {/* Popular Posts */}
        <div className="relative mb-8 p-3 md:p-6 w-full lg:w-full h-auto overflow-hidden bg-white shadow rounded-md">
  ...
  <div className="relative z-10">
    <h3 className="text-3xl font-semibold py-6 border-dashed border-pink-500 border-b-2 mb-10">Popular Posts</h3>
    
    <ul className="space-y-7">
      {popularPosts.map((post, index) => (
        <li key={index} className="flex flex-row space-x-4 space-y-3 items-start">
        <a href={post.link} className="flex-shrink-0 w-20 h-20">
          <img
            src={post.img}
            alt=""
        ...
        {/* Categories */}
<div className="relative mb-8 p-5 w-full lg:w-full h-[329px] overflow-hidden bg-white shadow rounded-md">
